...
, medicine_type = '" . (int)$data['medicine_type'] . "'");
	...
	public function editProduct($product_id, $data) {
		//echo "<pre>"; print_r($data); die;	
		$this->db->query("UPDATE " . DB_PREFIX . "product SET model = '" . $this->db->escape((string)$data['model']) . "', sku = '" . $this->db->escape((string)$data['sku']) . "', upc = '" . $this->db->escape((string)$data['upc']) . "', ean = '" . $this->db->escape((string)$data['ean']) . "', jan = '" . $this->db->escape((string)$data['jan']) . "', isbn = '" . $this->db->escape((string)$data['isbn']) . "', mpn = '" . $this->db->escape((string)$data['mpn']) . "', location = '" . $this->db->escape((string)$data['location']) . "', quantity = '" . (int)$data['quantity'] . "', minimum = '" . (int)$data['minimum'] . "', subtract = '" . (int)$data['subtract'] . "', stock_status_id = '" . (int)$data['stock_status_id'] . "', date_available = '" . $this->db->escape((string)$data['date_available']) . "', manufacturer_id = '" . (int)$data['manufacturer_id'] . "', shipping = '" . (int)$data['shipping'] . "', price = '" . (float)$data['price'] . "', points = '" . (int)$data['points'] . "', weight = '" . (float)$data['weight'] . "', weight_class_id = '" . (int)$data['weight_class_id'] . "', length = '" . (float)$data['length'] . "', width = '" . (float)$data['width'] . "', height = '" . (float)$data['height'] . "', length_class_id = '" . (int)$data['length_class_id'] . "', status = '" . (int)$data['status'] . "', tax_class_id = '" . (int)$data['tax_class_id'] . "', brand_id = '" . (int)$data['brand'] . "', sort_order = '" . (int)$data['sort_order'] . "', date_modified = NOW(), is_prescription_required = '" . (int)$data['is_prescription_required'] . "'
, Is_brekable = '" . (int)$data['Is_brekable'] . "'
, tablets_per_strip = '" . (int)$data['tablets_per_strip'] . "'
, per_tablet_price = '" . $data['per_tablet_price'] . "'
, medicine_type = '" . (int)$data['medicine_type'] . "' WHERE product_id = '" . (int)$product_id . "'");
	...
	public function copyProduct($product_id) {
		...
		if ($query->num_rows) {
			...
			$data['product_brand'] = $this->getProductBrands($product_id);
	...
	public function getProductBrands($product_id) {
		...
		$query = $this->db->query("SELECT brand_id FROM " . DB_PREFIX . "product WHERE product_id = '" . (int)$product_id . "'");
