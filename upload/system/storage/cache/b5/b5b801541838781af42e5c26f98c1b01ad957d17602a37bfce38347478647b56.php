...
class __TwigTemplate_cf1492327c2a761e5806831466bdcaf58ac1e4ca8d9b82140bf3a6f3be75be74 extends Twig_Template
{
  ...
  <div class=\"modal-dialog\">
    <div class=\"modal-content\">
      <div class=\"modal-header\">
        <h5 class=\"modal-title text-danger\"><i class=\"fa fa-exclamation-triangle\"></i> ";
        // line 5
      ...
      <div class=\"modal-body\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["path"]) {
            ...
            if ((twig_length_filter($this->env, $context["path"]) > twig_length_filter($this->env, (isset($context["document_root"]) ? $context["document_root"] : null)))) {
                ...
                echo "                        <a href=\"";
                echo $context["path"];
                echo "\" class=\"dropdown-item\"><i class=\"fa fa-exclamation-triangle fa-fw text-danger\"></i> ";
                echo $context["path"];
                echo "</a>
                      ";
            } else {
                ...
                echo "                        <a href=\"";
                echo $context["path"];
                echo "\" class=\"dropdown-item\"><i class=\"fa fa-check-circle fa-fw text-success\"></i> ";
                echo $context["path"];
                echo "</a>
                      ";
            }
...
/*     <div class="modal-content">*/
/*       <div class="modal-header">*/
/*         <h5 class="modal-title text-danger"><i class="fa fa-exclamation-triangle"></i> {{ heading_title }}</h5>*/
/*         <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>*/
/*       </div>*/
/*       <div class="modal-body">*/
...
/*               <div class="input-group">*/
/*                 <div class="input-group-prepend dropdown">*/
/*                   <button type="button" id="button-path" data-toggle="dropdown" class="btn btn-primary dropdown-toggle">{{ document_root }} <span class="caret"></span></button>*/
/*                   <div class="dropdown-menu">*/
/*                     {% for path in paths %}*/
/*                       {% if path|length > document_root|length %}*/
/*                         <a href="{{ path }}" class="dropdown-item"><i class="fa fa-exclamation-triangle fa-fw text-danger"></i> {{ path }}</a>*/
/*                       {% else %}*/
/*                         <a href="{{ path }}" class="dropdown-item"><i class="fa fa-check-circle fa-fw text-success"></i> {{ path }}</a>*/
/*                       {% endif %}*/
/*                     {% endfor %}*/
/*                   </div>*/
/*                 </div>*/
