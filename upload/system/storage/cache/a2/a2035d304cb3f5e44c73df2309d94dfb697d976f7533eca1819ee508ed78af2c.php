...
class __TwigTemplate_4916d49ab022e4947b2ee5e1d34f2f722fbc89d78c1fb71b22b99920c1d4d04b extends Twig_Template
{
...
/*               <td class="text-left"><div class="input-group btn-block" style="max-width: 200px;">*/
/*                 <input type="text" class="form-control" name="quantity[{{ product.cart_id }}]" value="{{ product.quantity }}" size="1">*/
/*                 <div class="input-group-append">*/
...
/*         <div class="float-right"><a href="{{ checkout }}" class="btn btn-primary">{{ button_checkout }}</a></div>*/
/*       </div>*/
/*       {{ content_bottom }}</div>*/
/*     {{ column_right }}</div>*/
/* </div>*/
