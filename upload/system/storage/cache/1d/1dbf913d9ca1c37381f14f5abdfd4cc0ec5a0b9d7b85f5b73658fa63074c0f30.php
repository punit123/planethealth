...
/* design/theme.twig */
class __TwigTemplate_d091d08b5adf24fec17664c93d4f571fda929aeb9eeb943e0db8232657232c1d extends Twig_Template
{
...
\t\t\t\t\t\$('.nav-tabs').append('<li class=\"nav-item\"><a href=\"#tab-' + tab_id + '\" data-toggle=\"tab\" class=\"nav-link\">' + \$(element).attr('href').split('/').join(' / ') + '&nbsp;&nbsp;<i class=\"fa fa-minus-circle\"></i></a></li>');
...
\t\t\t\t\t\$('.nav-tabs').append('<li class=\"nav-item\"><a href=\"#tab-' + tab_id + '\" data-toggle=\"tab\" class=\"nav-link\">' + \$(element).parent().parent().find('input[name=\"path\"]').val().split('/').join(' / ') + '&nbsp;&nbsp;<i class=\"fa fa-minus-circle\"></i></a></li>');
...
";
    ...
    {
        return array (  533 => 409,  520 => 399,  495 => 377,  458 => 345,  452 => 344,  428 => 323,  413 => 311,  374 => 275,  367 => 271,  354 => 261,  331 => 241,  268 => 183,  262 => 182,  236 => 159,  180 => 106,  138 => 67,  113 => 45,  107 => 42,  98 => 36,  91 => 31,  80 => 29,  76 => 28,  72 => 27,  65 => 23,  56 => 17,  48 => 11,  37 => 9,  33 => 8,  27 => 5,  19 => 1,);
    }
}
/* {{ header }}{{ column_left }}*/
/* <div id="content">*/
...
/*   <div class="container-fluid">*/
/*     <div class="card">*/
/*       <div class="card-header"><i class="fa fa-list"></i> {{ text_edit }}</div>*/
/*       <div class="card-body">*/
/*         <div class="row">*/
/*           <div class="col-lg-3 col-md-3 col-sm-12">*/
/*             <div class="list-group">*/
