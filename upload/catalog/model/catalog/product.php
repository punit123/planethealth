...
class ModelCatalogProduct extends Model {
	...
	public function getProductsBySearch($word){
		$query = $this->db->query("SELECT * FROM " .  DB_PREFIX . "product_description WHERE (name LIKE '%".$word."%') OR (description LIKE '%".$word."%') ");
		return $query->rows;
	}
	...
	public function getFeaturedproduct($featured_product_id)
	{
		 $product_id=implode(",",$featured_product_id);
		  //$query = $this->db->query("SELECT * FROM `" . DB_PREFIX . "product_description` WHERE product_id IN($product_id)");
