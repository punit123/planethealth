...
class ModelAccountAddress extends Model {
	...
	public function editAddress($address_id, $data) {
		$this->db->query("UPDATE " . DB_PREFIX . "address SET firstname = '" . $data['firstname'] . "', lastname = '" . (string)$data['lastname'] . "', phone = '" . $data['phone'] . "',  email = '" . $data['email'] . "', company = '" . $data['company'] . "', address_1 = '" . $data['address_1'] . "', address_2 = '" . $data['address_2'] . "', area = '" . $data['area'] . "', postcode = '" . $data['postcode'] . "', city = '" . $data['city'] . "',  zone_id = '" . $data['zone_id'] . "', country_id = '" . $data['country_id'] . "', address_type = '" . $data['address_type'] . "', custom_field = '" . $this->db->escape(isset($data['custom_field']['address']) ? json_encode($data['custom_field']['address']) : '') . "' WHERE address_id  = '" . $address_id . "' AND customer_id = '" . (int)$this->customer->getId() . "'");
		if (!empty($data['default_address'])) {
